...
#          , e = o.encrypt.generateRandomIntString(16);
    ...
    def generate_random_int_string(self, t):
        result = ''
        for _ in range(t):
    ...
    def init_aes(self):
        ...
        t = self.generate_random_int_string(16)
        e = self.generate_random_int_string(16)

        self.aes_key = t.encode()
        self.aes_iv = e.encode()
